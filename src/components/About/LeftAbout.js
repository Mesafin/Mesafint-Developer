      ...
      <div className="flex flex-col gap-6 text-justify pb-20 ">
        ...
        <h1 className='text-3xl text-resumetext font-bold font-titleFont pt-5' >About Me</h1>
          <p className="  w-full font-bodyFont leading-6 tracking-wide">
            ...
            I design and code beautifully simple web applications that deliver seamless user experiences and drive business success. I am Quick Learner and dedicated to creating innovative solutions that exceed client expectations.
